...
const data = [
  {
    ...
    details: `
      <img src='./src/assets/flag-fr.png' alt='FR' style='width: 20px; height: 20px;' /> 
      ...
      <br /><br />
      <img src='./src/assets/flag-gb.png' alt='FR' style='width: 20px; height: 20px;' /> 
...
<img src='./src/assets/flag-gb.png' alt='FR' style='width: 20px; height: 20px;' />As part of my training at Studi, I was tasked with developing a showcase web application for the restaurant <a href='https://quai-antique.lespetitsdeveloppeurs.fr/'>Le Quai Antique</a>, led by Chef Arnaud Michant. Working independently, I took on this challenge by applying my skills and developing new ones, with the goal of creating an immersive experience that reflects the culinary excellence of the restaurant.
  ...
  },
  {
    ...
    details: `<img src='./src/assets/flag-fr.png' alt='FR' style='width: 20px; height: 20px;' />
...
<img src='./src/assets/flag-gb.png' alt='FR' style='width: 20px; height: 20px;' />I created <a href='http://foundation-phoenix.rf.gd/public/index.php'>Foundation Phoenix</a>, a website for managing data for a secret agency. I designed the database, developed both front and back-office interfaces using the MVC approach, and added bonus features like pagination and filters.
  ...
  },
  {
    ...
    details: `<img src='./src/assets/flag-fr.png' alt='FR' style='width: 20px; height: 20px;' /> Le projet <a href='https://app-trtconseil.herokuapp.com/'>TRT Conseil</a> visait à créer un site web pour une agence de recrutement hôtelier et gastronomique. Il permet l'inscription des candidats et recruteurs, avec des annonces gérées par ces derniers. Chaque élément est validé par un consultant, assurant une gestion efficace. Le site est convivial, professionnel, sécurisé et adaptable à tous les appareils, offrant une expérience utilisateur optimale pour trouver des candidats qualifiés.

<br /><br />
<img src='./src/assets/flag-gb.png' alt='FR' style='width: 20px; height: 20px;' />The project <a href='https://app-trtconseil.herokuapp.com/'>TRT Conseil</a> aimed to create a website for a hotel and restaurant recruitment agency. It allows candidates and recruiters to register, with job listings managed by the recruiters. Each listing is validated by a consultant, ensuring efficient management. The site is user-friendly, professional, secure, and adaptable to all devices, providing an optimal user experience for finding qualified candidates.
      `,
  },
  {
    year: 2023,
